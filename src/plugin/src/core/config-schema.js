...
exports.FeishuAccountConfigSchema = zod_1.z.object({
    ...
    // [openclaw-lark-plus] Multi-user fields
    authorizedUsers: zod_1.z.union([zod_1.z.literal('*'), zod_1.z.array(zod_1.z.string())]).optional(),
    userAgentMap: zod_1.z.record(zod_1.z.string(), zod_1.z.string()).optional(),
    userWorkspaces: zod_1.z.record(zod_1.z.string(), zod_1.z.object({
        systemPrompt: zod_1.z.string().optional(),
